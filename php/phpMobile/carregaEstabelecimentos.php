<?php
    ...
    acos(sin(endereco.latitude*PI()/180)*sin($userLatitude*PI()/180)+cos(endereco.latitude*PI()/180)*cos($userLatitude*PI()/180)*cos(endereco.longitude*PI()/180 - $userLongitude*PI()/180))*6371 as distancia
